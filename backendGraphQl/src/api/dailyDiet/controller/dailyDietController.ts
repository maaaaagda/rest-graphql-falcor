...
export class DailyDietController {
  ...
  public readonly getDailyDiets = async (parent, args: {date: string, dietId: string}, ctx: Context, info): Promise<IDailyDiet[]> => {  
  ...
  public readonly getDailyDietById = async (parent, args: {id: string}, ctx: Context, info): Promise<IDailyDiet> => {
  ...
  public readonly addDailyDiet = async (parent, args: {dailyDiet: IDailyDiet}, ctx: Context, info): Promise<IDailyDiet> => {
  ...
  public readonly updateDailyDiet = async (parent, args: {id: string, dailyDiet: IDailyDiet}, ctx: Context, info): Promise<IDailyDiet> => {
        this._authenticator.authenticate(ctx.token);
